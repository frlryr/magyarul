...
* If the words ends in a consonant a linking vowel is added based on it being front or
    back word.
* Back vowels: mostly o, sometimes a.
* Front vowels: usually e, sometime ö.
* Some consonant words might not need a linking vowerl.
    * e.g. sör - sört, asztal - asztalt, etc.
* On front vowel words the ö linking vowel is necessary when the final word is
    ö, ő, ü, or ű.
...
* On 1~2 syllables in/after the question focus, your voice will rise on the last
    syllable.
    * e.g. Eszter éhes?
...
* Used as a contrast in a second phrase.
    * e.g. Először levest kérek, utána pedig pörköltet. `<>` First I want a soup and
        then a stew.
...
* HINT: The question word is always the focus of a question. Therefore when answering
    a question-word question, first answer the question-word and the follow the word
    order of the rest of the question.
...
* Itthon, Itthonról are used when talking about your own, or someone else's home and you
    are actually there.
* Otthon, Otthonról are used when you are talking about your own, or someone else's home
